...
public class WaveformGenerator 
{
	...
	private Color waveAverageColor = new Color(200,240,240);
	private Color pointColor = new Color(255,255,0);
	private Color pointerColor = new Color(250,0,0);
...
//						lastAvgY = avgY;
	...
	//in experimental fase, temporary disabled
	public void drawPointer(Graphics g) {
		g.setColor(pointerColor);
		g.drawLine(getInnerX(), 0, getInnerX(), this.height);
